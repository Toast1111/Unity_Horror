...
public class SceneSetupExample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("8. Bake NavMesh for level");
        Debug.Log("See SETUP_GUIDE.md for detailed instructions");
    }
    ...
    public struct KeyDoorPair
    {
        ...
        public KeyDoorPair(string id, Vector3 keyPos, Vector3 doorPos)
        {
            keyID = id;
            keyPosition = keyPos;
    ...
    public static KeyDoorPair[] GetExampleKeyDoorPairs()
    {
        ...
        {
            new KeyDoorPair("Key_1", new Vector3(5, 0, 5), new Vector3(10, 0, 0)),
            new KeyDoorPair("Key_2", new Vector3(15, 0, 5), new Vector3(20, 0, 0)),
            new KeyDoorPair("Key_3", new Vector3(25, 0, 5), new Vector3(30, 0, 0))
        };
    }
